...
//Pre-defined cols
exports.COL_ENTITY_ID    = "_entityId";

types=[this.STRING,this.DOUBLE,this.INTEGER,this.DATE,this.TIMESTAMP,this.ARRAY,this.POINT,this.OBJECT,this.BOOLEAN];

exports.isValidType = function(pType)
{
   return pType!=undefined && types.includes(pType); 
}
...
exports.inferType = function(pObject)
{
   ...
   else
   {
     ...
     debug(JSON.stringify(pObject,null,2));
     return this.OBJECT;
   }
}
/**
