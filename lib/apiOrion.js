 ...
 * MIT Licensed
 *
 * This is a deprecated module implements the NGSI-V2 based on Orion.
 * 
 */
...
exports.service = function(req,res,next)
{
   ...
   var lServer=configsys.getOrionHost(lFiwareService);
   var lPort=configsys.getOrionPort(lFiwareService);
   ...
   lUrl=utils.addGeoLocation(lUrl,null,lCoords,lMinDistance,lMaxDistance,lGeorel,false); 
