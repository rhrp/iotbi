...
config.broker.servers.test_ld={host:'52.49.232.90',port:'2026',https:false,ngsi:'ldv1',broker:'OrionLD',ngsildContext:'http://context/ngsi-context.jsonld',jsonldContext:'http://context/json-context.jsonld'};
config.broker.servers['urn:ngsi-ld:test_ld']={host:'172.19.0.6',port:'9090',https:false,ngsi:'ldv1',broker:'Scorpio',ngsildContext:'http://context/ngsi-context.jsonld',
