...
var InMemoryCache = require('../cache/inMemory.js');

//var crypto = require('crypto');

const THRESHOLD_TRANSFORMER=0.60;
...
module.exports = class Transformer extends Base
{
  ...
  */
  async similarityBestScore(text,sentences)
  {
      ...
      for(let sentence of sentences)
      {
         ...
         if(lScore!=undefined && lScore.similarity>THRESHOLD_TRANSFORMER && (lBestScore==undefined || lScore.isGreaterThan(lBestScore)))
         {
  ...
  */
  async embeddings(sentences) 
  {
     ...
     if(sentences.length>50000)
     {
        throw new RangeError("The number of sentences exceds the system capacity!");
     }
