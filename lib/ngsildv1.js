 ...
 */
function listEntities(pEndpoint,pObjQuery,pFiwareService,pFiwareServicePath,pExtended,pTableNameJoin,pJoinAttribute)
{
...
function loadMainTable(pEndpoint,pObjQuery,pFiwareService,pFiwareServicePath,pExtended,pTableNameJoin,pJoinAttribute)
{
    ...
    return loadMainTablePage(pEndpoint,pObjQuery,pFiwareService,pFiwareServicePath,pExtended,pTableNameJoin,pJoinAttribute,0,lLimit,[])
}
function loadMainTablePage(pEndpoint,pObjQuery,pFiwareService,pFiwareServicePath,pExtended,pTableNameJoin,pJoinAttribute,pOffset,pLimit,pEntitiesAcumulator)
{
...
                   debug('statusCode:', response && response.statusCode);
                   ...
                   else
                   {
                        ...
                        if(lEntitiesPage.length==pLimit)
                        {
                            ...
                            return resolve(loadMainTablePage(pEndpoint,pObjQuery,pFiwareService,pFiwareServicePath,pExtended,pTableNameJoin,pJoinAttribute,lOffset,pLimit,pEntitiesAcumulator));
                        }
                        else
                        {
                            // Last page
