...
var ngsitsdg = require('./ngsitsdb.js');
...
exports.service = function(req,res,next)
{
   ...
   if(apiConfig.isBrokerSuportsTemporalAPI(lFiwareService))
   {
        ...
        serviceNGSITemporalAPI(req,res,lFiwareService,lFiwareServicePath,lEntityType,lEntityId,lAttrs,lIdPattern,lFromDate,lToDate,lFormat,lExtended,lLimit,lJoinTable);
   }
   else if(apiConfig.getQuantumLeapServerOk(lFiwareService))
   {
        console.log('Using NGSI-TSDB API');
        serviceQuantumLeap(req,res,lFiwareService,lFiwareServicePath,lEntityType,lEntityId,lAttrs,lIdPattern,lFromDate,lToDate,lFormat,lExtended,lLimit);
   }
   else
   {
...
function serviceQuantumLeap(req,res,pFiwareService,pFiwareServicePath,pEntityType,pEntityId,pAttrs,pIdPattern,pFromDate,pToDate,pFormat,pExtended,pLimit)
{
   ...
   var lTable=[];
   invokeRequestQuantumLeap(req,res,lUrl,lEntityType,lFiwareService,lFiwareServicePath,lFormat,lExtended,0,QL_LIMIT,pLimit,lTable)
   console.log('Ok!');
}
function serviceNGSITemporalAPI(req,res,pFiwareService,pFiwareServicePath,pEntityType,pEntityId,pAttrs,pIdPattern,pFromDate,pToDate,pFormat,pExtended,pLimit,pJoinTable)
{
   var NGSI = require('ngsijs');
