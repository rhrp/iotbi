...
module.exports = class Graph {
   ...
   static NGSI_PROPERTY     = 'NGSI_Property';		// Class of objects the represent properties of NGSI entities
   static NGSI_RELATIONSHIP = 'NGSI_Relationship';      // Class of objects the represent relationships of NGSI entities
  /**
   *
   */
   constructor(name) 
