...
function hookEndRequest(req,res,next)
{
   ...
   for(let lFiwareService in lMarksByBrokerPage)
   {
       ...
       if(lMarkEndTransform && lTimeEndLastPage!=undefined)
       {
          ...
          debug(`Broker[${lFiwareService}] Last page: ${lTimeEndLastPage} \t End transform: ${lMarkEndTransform.startTime}   TransformTime: ${lBrokersTransformTime[lFiwareService]}   Rows: ${lBrokersRowsCount[lFiwareService]}`);
       }
   }
